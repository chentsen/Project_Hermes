...
class Application_View_Helper_DisplayFeed extends Zend_View_Helper_Abstract{
	...
	public function getEventFeedMessage(FeedObject $feedObject){
		...
		echo "<img style='float: left; margin-right: 5px; margin-top: 2px;' src='/images/calendar.png' width='30' height='30'/>";
	...
	public function getFriendAcceptFeedMessage(FeedObject $feedObject){
		...
		echo "<img style='float: left; margin-right: 5px; margin-top: 2px;' src='/images/placeholder.png' width='30' height='30'/>";
