            ...
            if($feedObject->getEvent())
                {
					...
					echo "<a href='/event/index/eid/".$feedObject->getEid()."' ><img src='".Application_Model_Utils_ImageUtil::getProfilePicURL($feedObject->getEvent->getCreator())."' height='150' width='150' /></a></div>";
