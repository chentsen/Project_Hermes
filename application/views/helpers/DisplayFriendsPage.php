...
class Zend_View_Helper_DisplayFriendsPage extends Zend_View_Helper_Abstract{
	...
	private $baseUrl;
	public function DisplayFriendsPage($identity, $baseUrl){
		...
		if($this->friendRelation){
			...
			if($list){
				foreach($list as $friend){
                                        ...
                                        echo "<img src='".$baseUrl.Application_Model_Utils_ImageUtil::getProfilePicURL($friend)."' height=100  width=100/></a></div><div class='friend_name'>";
